...
CREATE TABLE IF NOT EXISTS kaos_subscriptions (
    ...
    project text,
    publish_default boolean NOT NULL DEFAULT true,
...
-- Backward-compatible migrations for databases created before these columns.
ALTER TABLE kaos_subscriptions ADD COLUMN IF NOT EXISTS interval_seconds integer;
ALTER TABLE kaos_subscriptions ADD COLUMN IF NOT EXISTS project text;
